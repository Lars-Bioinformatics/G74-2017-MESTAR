...
# output_somatic = "mutect2_force_calling_mergedMatchedAndJointCalling_twist/"
# output_somatic = "test_mutect2_force_calling_matchedTumorNormal/"
# output_somatic = "test_mutect2_force_calling_matchedPlasmaPoolNormal/"
# output_somatic = "test_mutect2_force_calling_tumorOnly/"
output_somatic = "test_mutect2_matched_force_calling/"
...
onstart:
    ...
    shell("mkdir -p "+output_somatic+"vcf_{{raw,filterFlag}}")
    # shell("mkdir -p "+output_somatic+"vcf_{{raw,filterFlag,filterFlag_PASS,filterFlag_norm_PASS}}")
...
rule Mutect2_joint_calling_forced:
    input:
        ...
        force_intervals=output_somatic+"union_vcf/G74-D2_variants.vcf.gz"
    output:
        vcf=output_somatic+"vcf_raw/{sample}_somatic_mutect2.vcf.gz",
        idx=output_somatic+"vcf_raw/{sample}_somatic_mutect2.vcf.gz.tbi",
        realigned_bam=output_somatic+"realigned_bam/{sample}_somatic_mutect2.bam",
        vcf_stats=output_somatic+"vcf_raw/{sample}_somatic_mutect2.vcf.gz.stats",
...
rule FilterMutectCalls:
    input:
        ...
        idx=output_somatic+"vcf_raw/{sample}_somatic_mutect2.vcf.gz.tbi",
        bam=output_somatic+"realigned_bam/{sample}_somatic_mutect2.bam",
        stats=output_somatic+"vcf_raw/{sample}_somatic_mutect2.vcf.gz.stats",
